...
2. 프로젝트 준비: 제출된 소스코드 압축 파일 (`save_money_project.zip` 등)을 원하는 곳에 압축 해제합니다.
터미널(명령 프롬프트 또는 PowerShell)을 열고, 압축 해제한 `save_money_project` 폴더로 이동합니다.
(예: `cd C:\Users\YourName\Desktop\save_money_project`)
